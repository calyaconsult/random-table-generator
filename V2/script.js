...
//  $.getJSON("months-generated-values.json", function(allData) {
  $.getJSON("table-data-no-exorb-9.json", function(allData) { // Kann durch "node index.js" immer wieder neu generiert werden
    var data = allData; // allData[month]; // Nur 1 Datensatz
    let c = counter(0);
